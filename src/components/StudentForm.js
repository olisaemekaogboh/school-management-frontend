...
import { FaUpload, FaCamera, FaTrash, FaSave, FaArrowLeft } from 'react-icons/fa';
...
function StudentForm() {
    ...
    useEffect(() => {
        if (formData.stateOfOrigin) {
            ...
            if (formData.localGovtArea && !LGA_BY_STATE[formData.stateOfOrigin]?.includes(formData.localGovtArea)) {
    ...
    const validateForm = () => {
        ...
        if (!formData.localGovtArea) newErrors.localGovtArea = 'Local Government Area is required';
        ...
        if (formData.emergencyContactPhone && !/^\d{11}$/.test(formData.emergencyContactPhone)) {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            if (response.data?.profilePictureUrl) {
                setProfilePreview(`http://localhost:8080${response.data.profilePictureUrl}`);
            ...
            if (error.response?.data?.errors) {
                const errorMessages = error.response.data.errors.map(err => `${err.field}: ${err.defaultMessage}`).join(', ');
                toast.error(errorMessages);
            } else {
                toast.error(error.response?.data?.message || error.message || 'Failed to save student');
            }
        } finally {
            setLoading(false);
        }
                                    ...
                                    <div className="col-md-3 text-center">
                                            ...
                                            {profilePreview ? (
                                                ...
                                                >
                                                    <div className="text-center">
                                                        ...
                                                        <p className="mt-2 text-muted small">Click to upload</p>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        {formData.profilePicture && (
                                            <div className="text-success small mb-2">
                                                ✓ {(formData.profilePicture.size / (1024 * 1024)).toFixed(2)}MB / 5MB
                                            </div>
                                        )}
                                        ...
                                        {uploadProgress > 0 && uploadProgress < 100 && (
                                            <div className="progress mt-3" style={{ height: '5px', width: '180px', margin: '0 auto' }}>
                                                <div
                                    ...
                                    <div className="col-md-9">
                                        <div className="alert alert-info">
                                            ...
                                            <ul className="mb-0 small">
                                                ...
                                                <li>Accepted formats: <strong>JPEG, PNG, GIF</strong></li>
                                                <li>Recommended: <strong>Passport photograph (200x200 pixels)</strong></li>
                                                <li>The photo will appear on student's profile, result sheets, and ID card</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 mb-3">
                                ...
                                {errors.emergencyContactPhone && (
                                    <div className="invalid-feedback">{errors.emergencyContactPhone}</div>
                                )}
                            </div>
                            ...
                            <div className="col-md-4 mb-3">
                                <div className="form-check">
                                    <input
                                        ...
                                        onChange={handleChange}
                                    />
                                    <label className="form-check-label" htmlFor="excludeFromPromotion">
